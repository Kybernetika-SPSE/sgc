...
> R-2R síť se většinou znázorňuje s invertujícím operačním zesilovačem na výstupu, který odděluje zátěž od rezistorů aby nedocházelo k jejich vzájemnému ovlivňování. Ovšem, *KDO V HOBBY ZAPOJENÍCH POUŽÍVÁ SYMETRICKÉ NAPÁJENÍ ABY MOHL POUŽÍT INVERTUJÍCÍ OPERAČNÍ ZESILOVAČ*? Já rozhodně ne. Takže otočíme vstup a výstup a invertující OZ za napěťový sledovač (neinvertující OZ se zesílením 1).
